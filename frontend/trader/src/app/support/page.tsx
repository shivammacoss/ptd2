    ...
    <div className="flex flex-col h-screen bg-bg-primary">
      ...
      {showNewTicket && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative w-full max-w-md glass-card rounded-xl border border-border-glass shadow-2xl">
      ...
      {error && !tickets.length ? (
        ...
        <div className="flex flex-1 overflow-hidden">
          {/* Ticket List */}
          <div className="w-80 flex-shrink-0 glass-panel border-r border-border-glass flex flex-col">
            <div className="p-3 border-b border-border-glass flex items-center justify-between">
              <span className="text-md font-semibold text-text-primary">Support</span>
              <button
                onClick={() => setShowNewTicket(true)}
                className="p-1.5 text-text-tertiary hover:text-buy transition-all rounded-md hover:bg-bg-hover"
              >
