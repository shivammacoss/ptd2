...
class Order(Base):
    ...
    order_type = Column(SAEnum(OrderType, name="order_type", create_type=False, values_callable=lambda e: [x.value for x in e]), nullable=False)
    side = Column(SAEnum(OrderSide, name="order_side", create_type=False, values_callable=lambda e: [x.value for x in e]), nullable=False)
    status = Column(SAEnum(OrderStatus, name="order_status", create_type=False, values_callable=lambda e: [x.value for x in e]), default=OrderStatus.PENDING)
...
class Position(Base):
    ...
    side = Column(SAEnum(OrderSide, name="order_side", create_type=False, values_callable=lambda e: [x.value for x in e]), nullable=False)
    status = Column(SAEnum(PositionStatus, name="position_status", create_type=False, values_callable=lambda e: [x.value for x in e]), default=PositionStatus.OPEN)
    lots = Column(Numeric(10, 4), nullable=False)
