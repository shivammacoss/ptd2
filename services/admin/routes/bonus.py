...
from ..models import User, BonusOffer, UserBonus
from ..schemas import BonusOfferIn, BonusOfferOut, UserBonusOut, PaginatedResponse
...
async def create_bonus_offer(
    ...
    await write_audit_log(
        db, admin.id, "create_bonus_offer", "bonus_offer", offer.id,
...
async def update_bonus_offer(
    ...
    await write_audit_log(
        db, admin.id, "update_bonus_offer", "bonus_offer", offer_id,
